...
import { DEXSymbol, CEXSymbol, DEXSymbolRequest, CEXSymbolRequest, FileStatus } from '../types/symbols';
...
export const filesApi = {
  ...
  downloadFile: (fileType: 'pooladdress' | 'cex_symbols'): string => 
    `${API_BASE_URL}/api/files/download/${fileType}`,
  
  getFileContent: (fileType: 'pooladdress' | 'cex_symbols'): Promise<{content: string}> => 
